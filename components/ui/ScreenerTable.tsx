...
export default function ScreenerTable({
  ...
  const stickyThTint = "sticky top-[57px] z-10 bg-[#001a00]/40"; // tinted: 5Y RETURN + VERDICT
  const stickyThBase = "sticky top-[57px] z-10 bg-[#001200]";    // no tint: QUALITY
      ...
      <table className="w-full text-sm border-collapse">
        <thead>
          ...
          <tr className="bg-[#001200]">
            ...
            <th rowSpan={2} className="border-0 sticky top-[57px] right-0 z-30 bg-[#001200] px-2 py-3 text-center align-middle">
              <button
