            ...
            <th className={`px-4 py-3 ${cornerTh}`}>
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="text-[#00ff41]/50 hover:text-[#00ff41] text-[10px] border border-[#00ff41]/20 rounded px-1.5 py-0.5 transition-colors leading-none whitespace-nowrap"
                >
                  SCORES {scoresOpen ? "−" : "+"}
                </button>
              </div>
            ...
            <tr className="border-t border-[#00ff41]/20">
              <td colSpan={9} className="p-0">
                <div className="relative">
                  {/* Blurred locked rows rendered in a nested table */}
                  ...
                  {/* CTA overlay centred over the blurred rows */}
