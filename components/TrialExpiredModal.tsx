    ...
    >
      ...
      >
        <div className="px-6 py-5" style={{ borderBottom: '1px solid rgba(0,255,65,0.12)', background: 'rgba(0,255,65,0.04)' }}>
          ...
          <p className="text-lg font-bold tracking-widest" style={{ color: '#00ff41' }}>TRIAL EXPIRED</p>
        </div>

        <div className="px-6 py-6">
          <p className="text-xs leading-relaxed mb-6" style={{ color: 'rgba(0,255,65,0.55)' }}>
            Your 5-minute free trial has ended. Upgrade to Pro to keep full access to all 500 stocks, complete scoring breakdowns, and detail pages.
          </p>
